...
import { Calendar, Check, ChevronDown, GripVertical, MessageSquare, Pencil, Send, Trash2, User, X, XCircle } from 'lucide-react'
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          ...
          <div className="flex w-full flex-col gap-2 sm:w-auto sm:min-w-[220px] sm:items-end" onClick={(e) => e.stopPropagation()}>
            <div className="flex min-w-0 items-start justify-between gap-3 sm:w-full sm:justify-end">
              ...
              <ChevronDown className={`mt-0.5 h-4 w-4 shrink-0 text-muted-foreground transition-transform duration-200 ${expanded ? 'rotate-180' : ''}`} />
            </div>
